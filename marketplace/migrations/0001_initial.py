# Generated by Django 2.1.5 on 2019-01-13 21:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.Cart')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('category', models.CharField(blank=True, default='miscellaneous', max_length=100, null=True)),
